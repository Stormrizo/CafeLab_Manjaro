...
# %% [markdown]
# # Conversión de AChMG.txt a .csv
# Este notebook convierte los archivos originales de absorbancia de Chiapas - AChMG (molienda grande) de `.txt` a `.csv` sin pérdida de información
