...
fig.update_layout(
    title="Curvas de absorbancia - Café de Veracruz (Molienda normal)",
...
<body>
  ...
  <h1>Reporte de Absorbancia UV-Vis - Café de Veracruz molienda normal (MN) </h1>
  ...
  <div>
    <p>Se observa un comportamiento típico de absorbancia en función del gramaje. Las regiones espectrales ampliadas permiten evaluar la absorción en el ultravioleta cercano y visible, y compararlas con la concentración relativa de compuestos presentes.</p>
  </div>
